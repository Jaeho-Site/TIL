...
// ----------------------------------------------------------------------------
// 팩트 6. 모듈 관련 식별자들은 global의 프로퍼티가 아니다. (Node.js 특화)
// ----------------------------------------------------------------------------
// require, module, exports, __dirname, __filename은 마치 전역 변수처럼 
// 아무 곳에서나 쓸 수 있어서 착각하기 쉽지만, 사실 Node.js가 모듈을 래핑할 때 
// 함수의 인자로 몰래 주입해 주는 '지역 변수'입니다. 
// 따라서 global 객체 안에는 존재하지 않습니다.
console.log("팩트 6 확인 (require):", global.require === undefined);   // 출력: true
console.log("팩트 6 확인 (__dirname):", global.__dirname === undefined); // 출력: true